...
# ── Settings Metadata ────────────────────────────────────────────────
# CLI-only settings; STUDIO_SETTINGS entries carry their own description.
CLI_SETTING_DESCRIPTIONS: dict[str, str] = {
...
# Studio-exposed settings: tab, group, type, constraints and description.
STUDIO_SETTINGS: dict[str, dict[str, Any]] = {
    "MANIFEST_ENABLED": {
        "tab": "General",
        "group": "Manifest",
        "type": "bool",
        "description": "Write a manifest JSON file alongside generated artifacts for session tracking.",
    },
    "UPDATE_CHECK_ON_LAUNCH": {
        "tab": "General",
        "group": "Updates",
        "type": "bool",
        "description": "Check GitHub for a newer clipgen release when the desktop app starts. You can always check manually from the Start panel's About tab.",
    },
    "CLIP_PARALLEL_WORKERS": {
        ...
        "min": 0,
        "step": 1,
        "description": "Number of concurrent ffmpeg processes for clip generation. 0 = auto, 1 = sequential.",
    },
    "STUDIO_CELL_EXPAND_HOVER": {
        "tab": "General",
        "group": "Sheet Preview",
        "type": "bool",
        "description": "Expand overflowing timestamp cells on hover in the Sheet Preview.",
    },
    "STUDIO_CARD_SCRUBBER": {
        "tab": "General",
        "group": "Sheet Preview",
        "type": "bool",
        "description": "Hover a queue card's thumbnail to scrub through frames, hear the clip's audio, and see a waveform overlay.",
    },
    "CROSS_REFERENCES_ENABLED": {
        "tab": "General",
        "group": "Cross-References",
        "type": "bool",
        "description": "Show cross-reference badges linking spreadsheet, Screenspace, transcript, and Composer data across pages.",
    },
    "STUDIO_METADATA_CLUSTER_SCREENSPACE": {
        "tab": "General",
        "group": "Metadata Overview",
        "type": "bool",
        "description": "In the Metadata tab, count Screenspace data as time-adjacent clusters instead of raw events, so a dense scan doesn't overshadow the spreadsheet and transcript streams. On by default.",
    },
    "SCREENSHOT_FORMAT": {
        "tab": "General",
        "group": "Image Output",
        ...
        "description": "File format for screenshot artifacts. WebP is smaller but requires modern browsers (Safari 16+).",
    },
    "GIF_FORMAT": {
        "tab": "General",
        "group": "Image Output",
        ...
        "description": "File format for animated artifacts. WebM (VP9) is the smallest and most-compatible modern option; animated WebP is also small but requires Safari 16+; GIF works everywhere but is large.",
    },
    "WEBP_QUALITY": {
        "tab": "General",
        "group": "Image Output",
        ...
        "max": 100,
        "step": 1,
        "description": "WebP encoding quality (0-100). Higher values mean better quality and larger files.",
    },
    "SOURCE_FILENAME_PATTERN": {
        "tab": "Video & Clips",
        "group": "Source Videos",
        "type": "str",
        "description": "Filename pattern for source session videos in the input folder. Placeholders: {study}, {participant} (required). Extension comes from the video file format; multi-part recordings append -1, -2, … Example: {study}_{participant} matches mystudy_P01.mp4.",
    },
    "REENCODING": {
        "tab": "Video & Clips",
        "group": "Video Output",
        "type": "bool",
        "description": "Re-encode clips via ffmpeg instead of stream-copying. Slower but fixes some codec issues.",
    },
    "AUDIO_NORMALIZE": {
        "tab": "Video & Clips",
        "group": "Video Output",
        "type": "bool",
        "description": "Normalize audio levels across generated clips for consistent volume.",
    },
    "FILEFORMAT": {
        "tab": "Video & Clips",
        "group": "Video Output",
        ...
        "description": "Output container format for generated video clips.",
    },
    ...
    "MAX_FILESIZE_MB": {
        ...
        "min": 0,
        "step": 1,
        "description": "Compress output to stay under this size limit. Set to 0 to disable.",
    },
    "DEFAULT_DURATION_SECONDS": {
        ...
        "min": 1,
        "step": 1,
        "description": "Clip length when only a start time is provided.",
    },
    "MAX_CLIP_DURATION_SECONDS": {
        ...
        "min": 1,
        "step": 1,
        "description": "Prompt for confirmation before generating clips longer than this.",
    },
    "TITLECARDS_ENABLED": {
        "tab": "Video & Clips",
        "group": "Titlecards",
        "type": "bool",
        "description": "Prepend a generated titlecard to each video clip.",
    },
    "TITLECARD_DURATION_SECONDS": {
        ...
        "min": 1,
        "step": 1,
        "description": "Duration in seconds for the intro titlecard frame.",
    },
    "TITLECARD_IMAGE": {
        "tab": "Video & Clips",
        "group": "Titlecards",
        "type": "card_picker",
        "kind": "title",
        "description": "Background for the intro titlecard. Pick the default, a solid color, or upload your own image. The clip description is overlaid as text.",
    },
    "ENDCARD_IMAGE": {
        "tab": "Video & Clips",
        "group": "Titlecards",
        "type": "card_picker",
        "kind": "end",
        "description": "Background for the outro endcard. Pick the default, no endcard, a solid color, or upload your own image.",
    },
    ...
    "TITLECARD_COLOR": {
        ...
        "group": "Titlecards",
        "type": "hidden",
        "description": "Fill color used when the titlecard is set to a solid color.",
    },
    "ENDCARD_COLOR": {
        "tab": "Video & Clips",
        "group": "Titlecards",
        "type": "hidden",
        "description": "Fill color used when the endcard is set to a solid color.",
    },
    "HIGHLIGHTS_REEL_DURATION_SECONDS": {
        ...
        "min": 10,
        "step": 10,
        "description": "Maximum duration in seconds for the highlights reel time budget.",
    },
    "TRANSCRIBE_ENABLED": {
        "tab": "Transcription",
        "group": "Transcription",
        "type": "bool",
        "description": "Generate transcripts alongside clips using faster-whisper.",
    },
    "TRANSCRIBE_MODEL": {
        "tab": "Transcription",
        "group": "Transcription",
    ...
    "TRANSCRIBE_FORMAT": {
        ...
        "type": "select",
        "options": ["md", "srt", "vtt"],
        "description": "Transcript output format: md (Markdown), srt, or vtt.",
    },
    "TRANSCRIBE_PREWARM": {
        "tab": "Transcription",
        "group": "Transcription",
        ...
        "description": "When the Transcripts page pre-loads the Whisper model: off, queue_open (opening a pill's options pane or hovering a pill that needs transcription), or page_load (after listing participants).",
    },
    "TRANSCRIBE_CPU_THREADS": {
        ...
        "max": 64,
        "step": 1,
        "description": "CTranslate2 CPU threads for the Whisper model. 0 = auto (all cores).",
    },
    "TRANSCRIBE_DEVICE": {
        "tab": "Transcription",
        "group": "Transcription",
        ...
        "description": "Compute device for the Whisper model. auto = GPU only where the CUDA runtime is actually available (always CPU in the desktop app, which ships no CUDA). Set cuda only if you installed a matching cuBLAS/cuDNN yourself.",
    },
    "TRANSCRIBE_BEAM_SIZE": {
        ...
        "max": 5,
        "step": 1,
        "description": "Beam-search width. 1 = greedy (fastest); higher is slower for marginally better accuracy.",
    },
    "TRANSCRIBE_VAD_FILTER": {
        "tab": "Transcription",
        "group": "Transcription quality",
        "type": "bool",
        "description": "Use Silero VAD to transcribe speech spans only, skipping long silence (reduces silence hallucinations).",
    },
    "TRANSCRIBE_VAD_THRESHOLD": {
        ...
        "max": 1.0,
        "step": 0.05,
        "description": "Silero speech-probability cutoff when VAD is on. Lower = more permissive (catches quieter speech, fewer dropped words).",
    },
    "TRANSCRIBE_VAD_SPEECH_PAD_MS": {
        ...
        "max": 1000,
        "step": 50,
        "description": "Padding (ms) added to each detected speech span so word onsets/offsets aren't clipped by VAD.",
    },
    "TRANSCRIBE_VAD_MIN_SILENCE_MS": {
        ...
        "max": 10000,
        "step": 250,
        "description": "Minimum silence gap (ms) before VAD splits a speech span; higher avoids over-fragmenting.",
    },
    "TRANSCRIBE_NO_SPEECH_THRESHOLD": {
        ...
        "max": 1.0,
        "step": 0.05,
        "description": "Drop segments when no-speech probability exceeds this value (higher = stricter).",
    },
    "TRANSCRIBE_LOG_PROB_THRESHOLD": {
        ...
        "max": 0.0,
        "step": 0.1,
        "description": "Drop segments below this average log-probability (higher = stricter).",
    },
    "TRANSCRIBE_COMPRESSION_RATIO_THRESHOLD": {
        ...
        "max": 10.0,
        "step": 0.1,
        "description": "Drop segments whose gzip compression ratio exceeds this (catches repetitive loops).",
    },
    "TRANSCRIBE_HALLUCINATION_SILENCE_THRESHOLD": {
        ...
        "max": 10.0,
        "step": 0.5,
        "description": "Seconds of surrounding silence for hallucination skip logic; 0 = off. When > 0, enables word-level timestamps (slower).",
    },
    "TRANSCRIBE_CONDITION_ON_PREVIOUS_TEXT": {
        "tab": "Transcription",
        "group": "Transcription quality",
        "type": "bool",
        "description": "Use prior segment text as context for the next decode; disable to reduce chained hallucinations.",
    },
    "TRANSCRIBE_WORD_TIMESTAMPS": {
        "tab": "Transcription",
        "group": "Transcription quality",
        "type": "bool",
        "description": "Per-word timing via alignment. Tightens segment boundaries to the spoken words and enables the word-level playback highlight; adds decode time (roughly 10–30%).",
    },
    "TRANSCRIBE_EDGE_SNAP": {
        "tab": "Transcription",
        "group": "Transcription quality",
        "type": "bool",
        "description": "Snap segment boundaries to measured speech energy in the decoded audio, trimming silence overshoot at segment edges. Effectively free.",
    },
    "TRANSCRIBE_SPEAKERS": {
        "tab": "Transcription",
        "group": "Speakers",
        "type": "bool",
        "description": "Detect who is speaking and label each transcript line (Speaker 1, Speaker 2, …). Runs the bundled speaker model after transcription; each participant pill can override this.",
    },
    "TRANSCRIBE_SPEAKER_MAX": {
        ...
        "max": 8,
        "step": 1,
        "description": "Most speakers to tell apart per session (2–8). The count is detected automatically up to this cap.",
    },
    "MARK_CATEGORIES": {
        "tab": "Transcription",
        "group": "Markers",
        "type": "mark_categories",
        "description": "Categories available when marking transcript segments. Each entry has a label and a color swatch.",
    },
    "TRANSCRIBE_REDACT": {
        "tab": "Transcription",
        "group": "Redaction",
        "type": "bool",
        "description": "Find personal data (names, emails, phones, addresses, ids) in transcripts and show placeholders instead. Runs the Redact model after transcription; each participant pill can override this. Needs the model download below.",
    },
    "TRANSCRIBE_REDACT_MIN_SCORE": {
        ...
        "max": 0.95,
        "step": 0.05,
        "description": "Confidence a detection needs before it is redacted. Lower catches more, with more false positives.",
    },
    "TRANSCRIBE_REDACT_ORG": {
        "tab": "Transcription",
        "group": "Redaction",
        "type": "bool",
        "description": "Also redact organisation and company names.",
    },
    "HOTKEY_OVERRIDES": {
        "tab": "Hotkeys",
        "group": "",
        "type": "hotkeys",
        "description": "Custom keyboard-shortcut bindings, keyed by action id. Click a shortcut to rebind it; an empty value disables the shortcut.",
    },
    "LLM_SUMMARY_ENABLED": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "bool",
        "description": "Auto-generate an AI summary of each transcript after transcription completes. Disable to keep summaries manual-only (the per-participant Regenerate Summary button still works).",
    },
    "LLM_CITATIONS_ENABLED": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "bool",
        "description": "Auto-generate citation links between summary claims and transcript segments after the summary completes. Disable to keep citations manual-only (the per-participant Regenerate Citations button still works).",
    },
    "LLM_FRICTION_ENABLED": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "bool",
        "description": "Auto-detect friction moments after the summary completes. Disable to keep friction manual-only (the per-participant Run/Re-run friction button still works). Uses the AI summary model.",
    },
    "LLM_REPORT_ENABLED": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "bool",
        "description": "Auto-generate a per-participant mini-report after the summary completes. Off by default: generate reports from the Overview page's Reports tab instead.",
    },
    "LLM_SUMMARY_MODEL": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "model_select",
        "provider": "llm",
        "description": "AI model for transcript summaries, citation linking, and friction detection. A Hugging Face ref (user/repo:QUANT) or a downloaded model name. Models already in the llama.cpp cache, HF cache, or Ollama are reused automatically.",
    },
    "LLM_FRICTION_MODEL": {
        "tab": "Summaries",
        "group": "AI Summary",
        ...
        "description": "AI model for friction-moment detection. Leave as 'Same as summary model' to reuse the summary model, or pick a different installed model.",
    },
    "LLM_REPORT_MODEL": {
        "tab": "Summaries",
        "group": "AI Summary",
        ...
        # Blank value inherits LLM_SUMMARY_MODEL; surfaced as this option.
        "emptyLabel": "Same as summary model",
        "description": "AI model for mini-report generation. Leave as 'Same as summary model' to reuse the summary model, or pick a different installed model.",
    },
    "LLM_BASE_URL": {
        "tab": "Summaries",
        "group": "AI Summary",
        "type": "str",
        "description": "Base URL of the local llama-server router.",
    },
    "LLM_SUMMARY_PROMPT": {
        "tab": "Summaries",
        "group": "Agent prompts",
        "type": "prompt",
        "placeholders": ["text"],
        "description": "Prompt that generates each session summary. Keep the {text} placeholder. The transcript is inserted there.",
    },
    "LLM_CITATIONS_SYSTEM": {
        ...
        "type": "prompt",
        "placeholders": [],
        "description": "System instruction that frames the citation agent's behavior. Sent verbatim; no placeholders.",
    },
    "LLM_CITATIONS_PROMPT": {
        ...
        "description": "Prompt that links summary claims to transcript segments. Keep the {claims} and {transcript} placeholders.",
    },
    "LLM_FRICTION_SYSTEM": {
        "tab": "Summaries",
        "group": "Agent prompts",
        "type": "prompt",
        "placeholders": [],
        "description": "System instruction that frames the friction agent's behavior. Sent verbatim; no placeholders.",
    },
    "LLM_FRICTION_PROMPT": {
        "tab": "Summaries",
        "group": "Agent prompts",
        ...
        "description": "Prompt that detects friction moments. Keep the {summary}, {segments}, and {limit} placeholders.",
    },
    "LLM_REPORT_SYSTEM": {
        "tab": "Summaries",
        "group": "Agent prompts",
        "type": "prompt",
        "placeholders": [],
        "description": "System instruction that frames the report agent's behavior. Sent verbatim; no placeholders.",
    },
    "LLM_REPORT_PROMPT": {
        "tab": "Summaries",
        "group": "Agent prompts",
        ...
        "description": "Prompt that writes the per-participant mini-report. Keep the {participant}, {summary}, {observations}, and {bookmarks} placeholders.",
    },
    "SCREENSPACE_CV_RESOLUTION_SCALE": {
        ...
        "max": 4.0,
        "step": 0.25,
        "description": "Scale extracted region frames before CV analysis. Higher (e.g. 2.0) gives the models more signal on noisy/compressed video at the cost of speed and memory; lower speeds up scans on large footage. 1.0 = unchanged.",
    },
    "SCREENSPACE_FAST_SCAN_SKIP_NONKEY": {
        "tab": "Screenspace",
        "group": "Analysis Quality",
        "type": "bool",
        "description": "Fast scans decode only keyframes on H.264/HEVC when the source's keyframe interval is short enough that no samples are lost (auto-probed per video), giving large decode savings. Turn off to always full-decode. Only affects fast scans; the precise scan path is never changed.",
    },
    "SCREENSPACE_STATIC_FRAME_SKIP_THRESHOLD": {
        ...
        "max": 10.0,
        "step": 0.5,
        "description": "Skip frames whose average pixel difference from the previous sampled frame is below this value (Similarity/Text/Numbers/Scene scans). Lower = process more frames (catch subtle changes); higher = skip more aggressively on noisy footage. Default 2.0.",
    },
    "SCREENSPACE_RESTORE_MARKERS_ON_EDIT": {
        "tab": "Screenspace",
        "group": "Task Editing",
        "type": "bool",
        "description": "When editing a task, restore the In/Out timeline markers to the range it was originally run with. Disable to keep your current markers in place when iterating across different parts of the timeline.",
    },
    "SCREENSPACE_SHOW_CONFIDENCE_HISTOGRAM": {
        "tab": "Screenspace",
        "group": "Results Display",
        "type": "bool",
        "description": "Show a confidence-distribution histogram above the Results list (for tools that have confidence scores). Lets you see where detections cluster before moving the certainty cutoff. Off by default.",
    },
    "SCREENSPACE_GROUPED_TOOL_NAV": {
        "tab": "Screenspace",
        "group": "Tool Selection",
        "type": "bool",
        "description": "Group the analysis tools into category dropdowns (Difference, Detection, Classification, Attention, Utility) with a standalone Multitool chip, instead of a flat row of tool tabs. Easier to scan when picking a tool. On by default; turn off for the classic flat tab row.",
    },
    "SCREENSPACE_GENERATE_TEMPLATE_HEATMAP": {
        "tab": "Screenspace",
        "group": "Heatmaps",
        "type": "bool",
        "description": "Generate detection heatmaps (static image plus accumulation and rolling-window animations) for Template tasks. Disable to skip heatmap generation when you don't need it. Useful on long videos where it adds processing time.",
    },
    "SCREENSPACE_GENERATE_SHAPE_HEATMAP": {
        "tab": "Screenspace",
        "group": "Heatmaps",
        "type": "bool",
        "description": "Generate detection heatmaps (static image plus accumulation and rolling-window animations) for Shape tasks. Disable to skip heatmap generation when you don't need it. Useful on long videos where it adds processing time.",
    },
    "SCREENSPACE_GENERATE_FLOW_HEATMAP": {
        "tab": "Screenspace",
        "group": "Heatmaps",
        "type": "bool",
        "description": "Generate motion heatmaps (static image plus accumulation animation) for Flow tasks. Disable to skip heatmap generation when you don't need it.",
    },
    "SCREENSPACE_GENERATE_CHANGE_HEATMAP": {
        "tab": "Screenspace",
        "group": "Heatmaps",
        "type": "bool",
        "description": "Generate change heatmaps (static image plus accumulation and rolling-window animations) for Change tasks. Disable to skip heatmap generation when you don't need it. Useful on long videos where it adds processing time.",
    },
    "SCREENSPACE_GENERATE_ATTENTION_HEATMAP": {
        "tab": "Screenspace",
        "group": "Heatmaps",
        "type": "bool",
        "description": "Generate attention heatmaps (static image plus accumulation and rolling-window animations) for Attention tasks. The rolling-window animation is the closest analog to an eye-tracking gaze replay. Disable to skip heatmap generation when you don't need it.",
    },
    "SCREENSPACE_BOUNDARY_MERGE_THRESHOLD": {
        ...
        "max": 1.0,
        "step": 0.01,
        "description": "Boundary post-processing (Scene/Hybrid metrics): merge two periods whose content is at least this similar, removing the boundary between them. Higher = merge more aggressively (fewer boundaries); lower = keep more. Below the firing sensitivity by design.",
    },
    "SCREENSPACE_BOUNDARY_TYPE_THRESHOLD": {
        ...
        "max": 1.0,
        "step": 0.01,
        "description": "Boundary scene labeling (Scene/Hybrid metrics): distinct scenes closer than this are grouped into one 'type', labeled Scene A1, A2, … (same letter, different number). Looser than the merge threshold. Higher = group more scenes per type; lower = more distinct type letters.",
    },
    "SCREENSPACE_BOUNDARY_RELATIVE_PRUNE_ENABLED": {
        "tab": "Screenspace",
        "group": "Boundaries",
        "type": "bool",
        "description": "Boundary post-processing (Scene/Hybrid metrics): after merging, drop boundaries far weaker than the session's typical scene change. Adapts to each recording instead of a fixed threshold; disable to keep every detected boundary.",
    },
    "COMPOSER_DOUBLE_CLICK_CUTS": {
        "tab": "Composer",
        "group": "Timeline",
        "type": "bool",
        "description": "Double-click the Composer timeline to set the in point, then double-click again to commit the out point.",
    },
    "MEDIA_CONTAINER_WARNING": {
        "tab": "General",
        "group": "Media",
        "type": "bool",
        "description": "Warn when a source recording is a fragmented MP4 that browsers cannot seek (OBS 'fragmented recording'), and offer a one-click remux to fix it.",
    },
    "RICH_COLORS": {
        "tab": "CLI",
        "group": "Terminal Output",
        "type": "bool",
        "description": "Use colored terminal output via Rich library.",
    },
    "RICH_PANELS": {
        "tab": "CLI",
        "group": "Terminal Output",
        "type": "bool",
        "description": "Show bordered panels for error, warning, and success messages.",
    },
    "RICH_PROGRESS": {
        "tab": "CLI",
        "group": "Terminal Output",
        "type": "bool",
        "description": "Display progress bars during batch and reel processing.",
    },
}
