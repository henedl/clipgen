...
_EXCLUSIVE_MODES: tuple[_ModeSpec, ...] = (
    ...
    _ModeSpec(
        ...
        is_value=True,
        dispatch=cli_screenspace._run_ss_task,
    ),
    _ModeSpec(
        key="ss_run_task",
    ...
    _ModeSpec(
        ...
        is_value=True,
        dispatch=cli_screenspace._run_ss_list_tasks,
    ),
    _ModeSpec(
        key="summarize",
    ...
    _ModeSpec(
        ...
        dispatch=cli_event_clips._run_ss_clips,
    ),
    _ModeSpec(
        ...
        dispatch=cli_event_clips._run_transcript_clips,
    ),
    _ModeSpec(
        key="transcript_mark",
        ...
        is_value=True,
        dispatch=cli_event_clips._run_transcript_mark,
    ),
    _ModeSpec(
        key="regenerate",
