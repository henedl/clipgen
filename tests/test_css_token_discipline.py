...
_BASELINE = {
    ...
    "composer.css": (1, 4, 2, 5),
    "export-chrome.css": (2, 0, 0, 0),
    "gallery.css": (3, 0, 0, 0),
    "log-panel.css": (1, 0, 0, 0),
    "overview-convergence.css": (16, 1, 0, 0),
    "overview-metadata.css": (15, 1, 0, 0),
    "overview-reports.css": (0, 0, 2, 1),
    "overview.css": (0, 0, 1, 0),
    "primitives.css": (36, 3, 0, 0),
    "screenspace.css": (50, 0, 1, 13),
    "settings-modal.css": (10, 0, 1, 4),
    "start-overlay.css": (165, 9, 34, 10),
    "studio.css": (48, 5, 9, 24),
    "topnav.css": (23, 0, 0, 0),
