...
(function () {
  ...
  var HOTKEY_CATALOG = [
    ...
    { id: "composer.deleteSelection",  section: "composer", group: "Cuts", label: "Delete selected annotation / cut", combos: ["Backspace", "Delete"] },
    ...
    { id: "composer.swapColors",       section: "composer", group: "Annotate", label: "Swap primary / secondary color", combos: ["X"] },
    ...
    { id: "screenspace.regionRect",  section: "screenspace", group: "Regions", label: "Rectangle select tool", combos: ["R"] },
    { id: "screenspace.regionLasso", section: "screenspace", group: "Regions", label: "Lasso select tool", combos: ["T"] },
    { id: "screenspace.regionWand",  section: "screenspace", group: "Regions", label: "Magic wand select tool", combos: ["Y"] },
    ...
    { id: "transcripts.setIn",        section: "transcripts", group: "Transcribe range", label: "Set in marker", combos: ["I"] },
    ...
    { id: "overview.tabMetadata",    section: "overview", group: "Tabs", label: "Show Metadata tab", combos: ["1"] },
    { id: "overview.tabConvergence", section: "overview", group: "Tabs", label: "Show Convergence tab", combos: ["2"] },
    { id: "overview.tabReports",     section: "overview", group: "Tabs", label: "Show Reports tab", combos: ["3"] },
