...
(function () {
  ...
  // satellite once it has registered SS.cal*. _suppressCalibrationRefresh lives
  // here (not in the satellite) because it is hub coordination: set during
  // restoreTaskToWorkflow and checked in the single-tool param panels.
  ...
  // Additional hub helpers the calibration satellite reuses.
