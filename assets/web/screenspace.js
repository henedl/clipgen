...
(function () {
  ...
  // The timeline satellite owns the window resize/scroll listeners that drop the
  // cached canvas rects; it invalidates this hub-owned overlay rect through this
  // helper (published as SS.invalidateOverlayRect) since it can't touch the var.
