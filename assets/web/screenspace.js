...
(function () {
  ...
  // Hub helpers the tasks satellite (screenspace-tasks.js) reuses. findTask,
  // restoreTaskToWorkflow, setInputValue and syncValueDisplays now live in that
  // satellite and are published from there (the hub keeps thin delegators for
  // the entry points its own code calls); loadAndShowResults / renderResults are
  // still hub-owned here and move to screenspace-results.js later.
